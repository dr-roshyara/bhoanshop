          ...
          <div class="w-full flex flex-col min-w-full mx-auto py-4">
            ...
            <form class="mt-8 space-y-6" @submit.prevent="loginFn">
              ...
              <button
                ...
                class="px-7 py-3 text-white bg-sky-800 hover:bg-slate-300 font-medium text-sm leading-snug uppercase rounded shadow-md hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out w-full flex justify-center items-center mb-3"
              >
                <!-- Facebook -->
                <svg
              ...
              <button
                ...
                data-mdb-ripple="true"
                data-mdb-ripple-color="light"
                class="px-7 py-4 bg-red-500 hover:bg-red-200 hover: text-slate-100 text-white font-medium text-sm leading-snug uppercase rounded shadow-md hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out w-full flex justify-center items-center"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 488 512"
