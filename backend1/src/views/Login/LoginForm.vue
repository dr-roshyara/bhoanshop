        ...
        <div class="mx-auto w-full h-full text-gray-800">
          <div class="w-full flex flex-col min-w-full mx-auto py-4">
            ...
            <form class="mt-8 space-y-6" @submit.prevent="loginFn">
              ...
              <!-- email  -->
              <text-input v-model="credentials.email" type="email" name="email" label-name="Email"></text-input>
              <!-- password  -->
              <text-input
                ...
                required
                autocomplete="current-password"></text-input>

              <div class="flex px-2 md:px-3 text-sm tracking-tighter justify-start space-x-4">
                ...
                <div class="">
                  <router-link to="/reqpass" class="text-indigo-700 text-sm hover:text-indigo-500">
              ...
              <div class="bg-sky-800 hover:bg-slate-300 rounded-lg px-6 md:px-7 mx-2 mb-4">
                <button
                  type="button"
              ...
              <!-- Twitter -->
              <!-- Google -->
              <div class="bg-red-500 hover:bg-red-200 hover: text-slate-100 rounded-lg px-6 md:px-7 mx-2 mt-2">
                <button
                  type="button"
                  data-mdb-ripple="true"
                  data-mdb-ripple-color="light"
