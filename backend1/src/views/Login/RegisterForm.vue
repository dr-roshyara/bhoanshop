          ...
          <div class="w-full py-10 px-2 md:px-10">
            ...
            <form @submit.prevent="registerFn">
              ...
              <text-input
                ...
                placeholder="Nab"></text-input>
              <!-- email  -->
              <text-input v-model="user.email" type="email" name="email" label-name="Email"></text-input>

              <!-- password  -->
              <text-input v-model="user.password" type="password" name="password" label-name="Password"></text-input>
              <!-- password conformation  -->
              <text-input
                v-model="user.password_confirmation"
                type="password"
                name="password_confirmation"
                label-name="Password Confirmation"></text-input>
