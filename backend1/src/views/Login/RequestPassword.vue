...
<template>
  <GuestLayout title="Request new password">
    <div
      class="min-w-screen min-h-screen flex flex-col items-baseline md:items-center md:justify-center p-2"
    >
      <div
        class="bg-slate-50 text-gray-500 rounded-3xl shadow-xl md:w-2/3 overflow-hidden"
        style="max-width: 1000px mx-auto"
      >
        <div class="flex flex-col p-2 md:p-4 text-center mx-auto md: max-w-lg">
